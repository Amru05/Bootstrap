...
async function showDeleteUser(id) {
    fetch("/admin/user/" + id)
        ...
        .then(user => {
            ...
            document.getElementById("deluserFirstName").value = user.name;
...
async function showEditUser(id) {
    fetch("/admin/user/" + id)
        ...
        .then(user => {
            ...
            document.getElementById('edituserName').value = user.nName;
...
async function editUser(id) {
    ...
    let firstName = document.getElementById('edituserName').value;
